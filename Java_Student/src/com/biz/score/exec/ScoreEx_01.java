 ...
 *  엑셀은 xls, xlsx파일 외에 *.csv라는 파이을 읽어서 
 *  엑셀 데이터처럼 취급할수 있는데 *.csv 파일은 컴마로 데이터들을 구문하는 문자열로 만들고
...
public class ScoreEx_01 
{
	public static void main(String[] args) 
	{
		...
		for(int i=0; i< 30; i++)
		{
			...
			String score = String.format("%d, %d, %d, %d, %d", i+1, intKor, intEng, intMath, intSum, intAvg);
